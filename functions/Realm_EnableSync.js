...
exports = async function enablesync() {
  ...
  var configtxt = '{"clusterId":"623928bfee701e0873b95a6d","clusterName":"Cluster0","clusterType":"atlas","groupName":"M001","orgName":"M01","readPreference":"primary","sync":{"state":"enabled","database_name":"tracker","partition":{"key":"_partition","type":"string","required":true,"permissions":{"read":{"%%true":{"%function":{"arguments":["%%partition"],"name":"canReadPartition"}}},"write":{"%%true":{"%function":{"arguments":["%%partition"],"name":"canWritePartition"}}}}}},"wireProtocolEnabled":false}'
  var config = EJSON.parse(configtxt);
  //return config;
